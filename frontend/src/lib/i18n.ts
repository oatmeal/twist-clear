...
const en: Translations = {
  ...
  loginBannerWithDate: (date) => `Clips up to ${date} are saved here. Log in with Twitch to also see newer ones.`,
  loginBannerNoDate: 'Clips up to a recent date are saved here. Log in with Twitch to also see newer ones.',
...
const ja: Translations = {
  ...
  refreshingBtn: '更新中…',
  dismissBanner: '閉じる',
  loginBannerWithDate: (date) => `${date}までのクリップを保存しています。それ以降の新しいクリップも見るには、Twitchでログインしてください。`,
  loginBannerNoDate: 'このサイトに保存されていない新しいクリップも見るには、Twitchでログインしてください。',
