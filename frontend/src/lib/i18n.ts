...
const en: Translations = {
  ...
  loginBannerWithDate: (date) => `Clips up to ${date} are viewable here. Log in with Twitch to also see newer ones.`,
  loginBannerNoDate: 'To view new clips that have not yet been recorded on this site, please log in with Twitch.',
  ...
  helpLoginDescWithDate: (date) => `Clips up to ${date} are viewable here. Log in with Twitch to also fetch newer clips live from Twitch.`,
  helpLoginDescNoDate: 'To view new clips that have not yet been recorded on this site, please log in with Twitch.',
...
const ja: Translations = {
  ...
  refreshingBtn: '更新中…',
  dismissBanner: '閉じる',
  loginBannerWithDate: (date) => `${date}までのクリップが閲覧できます。それ以降の新しいクリップも見るには、Twitchでログインしてください。`,
  loginBannerNoDate: 'このサイトに記録されていない新着クリップも見るには、Twitchでログインしてください。',
  ...
  helpLogin: 'ログイン',
  helpLoginDescWithDate: (date) => `${date}までのクリップが閲覧できます。Twitchでログインすると、それ以降の新着クリップも確認できます。`,
  helpLoginDescNoDate: 'このサイトに記録されていない新着クリップも見るには、Twitchでログインしてください。',
  helpTimezone: 'タイムゾーン',
